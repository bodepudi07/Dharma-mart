...
export type IconName =
    ...
    | 'user-edit' | 'users' | 'users-group' | 'volume-off' | 'volume-on' | 'wifi' | 'wifi-off' | 'x' | 'zoom-in' | 'cow' | 'check' | 'package' | 'shield' | 'box' | 'zap' | 'globe' | 'sun' | 'moon' | 'droplet' | 'heart' | 'heart-filled' | 'copy' | 'chat' | 'lock' | 'info-circle' | 'alert-circle' | 'bookmark' | 'refresh-cw' | 'qr-code';
